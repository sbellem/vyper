...
class VariableRecord:
    def __init__(
        ...
        *,
        ...
        self.defined_at = (
            defined_at  # source code location variable record was defined.
        )
...
class FunctionSignature:
    ...
    def from_definition(
        ...
        for arg in code.args.args:
            ...
            args.append(
                VariableRecord(
                    arg.arg, mem_pos, parsed_type, False, defined_at=getpos(arg),
                )
            )
        ...
        for dec in code.decorator_list:
            ...
            elif isinstance(dec, vy_ast.Name) and dec.id == "mpc":
                mpc = True
            else:
                raise StructureException("Bad decorator", dec)

        if mpc:
            print("mpc programs not supported yet")
        ...
        if (not public and not private) and not contract_def and not mpc:
            raise StructureException(
